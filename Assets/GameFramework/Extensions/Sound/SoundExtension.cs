...
namespace GameFramework.Extensions.Sound
{
    public static class SoundExtension
    {
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, GameMain.Entity bindingEntity = null, object userData = null)
        {
